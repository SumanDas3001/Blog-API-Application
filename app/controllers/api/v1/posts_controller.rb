  ...
  class PostsController < ApplicationController
    ...
    swagger_path '/posts/{id}' do
      operation :get do
        ...
        key :description,
            'API for viewing a post with all of its comments and count of likes for the post, count of likes for each comment and read post'
        key :tags, ['Post']
        parameter do
          key :name, :Authorization
          key :description, 'Enter Authorization Key'
    ...
    swagger_path '/posts' do
      operation :post do
        key :summary, 'PI for creating a post'
